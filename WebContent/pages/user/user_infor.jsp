                                 ...
                                 <div id="tab-1" class="tab-pane active">
                                    <div class="form-horizontal">
											...
											<div class="form-group m-b-none">
												...
												<p class="col-lg-2 form-control-static">${user.username }</p>
											</div>
											<div class="form-group m-b-none">
												<label class="col-lg-2 control-label">性别：</label>
												<p class="col-lg-2 form-control-static">${user.sex==1?'男':'女' }</p>
											</div>
											<div class="form-group m-b-none">
												<label class="col-lg-2 control-label">昵称 ：</label>
												<p class="col-lg-2 form-control-static">${user.nickname }</p>
											</div>
											<div class="form-group m-b-none">
                            ...
                            <div id="contact-1" class="tab-pane active">
                                <div class="row m-b-lg">
                                    <div class="col-lg-4 text-center">
                                        ...
                                        <div class="m-b-sm">
                                            <img alt="image" class="img-circle" src="${user.iconurl }" style="width: 62px">
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <h3>
