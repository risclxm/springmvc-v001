  ...
  <body>
    ...
    <div class="ch-container">
        ...
        <ul class="breadcrumb">
            ...
            <li>
                <a href="pages/user/user_list.jsp">用户基本信息管理</a>
            </li>
        </ul>
    </div>
    <div class="row">
    	...
    	table=$('#carouseTable').dataTable({
			...
			"columns": [
			            ...
			            {  "data": "status",
				               "width" : "80px",
							   "render" : function(data,type, row, meta) {
									return data=='2'?'<button type="button" class="btn btn-info" onclick="delUser('+row.id+',\'1\')">冻结</button>':'<button type="button" class="btn btn-success" onclick="delUser('+row.id+',\'2\')">正常</button>';
								}
				        },
			            { "data": "occupation" },
			            { "data": "province" },
			  ...
			  "columnDefs": [
			            {
			            	"targets": [11],
			            	"render" : function(data,type,row, meta) {
			            		//var str='<button type="button" class="btn btn-small btn-primary btn-edit" onclick="delUser('+row.id+')"><i class="glyphicon glyphicon-pencil"></i>冻结</button>';
			            		var str='<button type="button" class="btn btn-small btn-primary btn-edit" onclick="userdetail('+row.id+')"><i class="glyphicon glyphicon-pencil"></i>详情</button>';
			            		return str;
							}
			            }
			        ],
