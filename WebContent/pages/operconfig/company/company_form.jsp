...
%>
    ...
    <script type="text/javascript" charset="utf-8" src="bower_components/utf8-jsp/ueditor.all.min.js"> </script>
		...
		<div class="box-inner">
			<div class="box-content">
				<form action="comp/add" method="post" id="comp_form"
					...
					<div class="form-group has-success">
						<label class="control-label" for="user_name">权值* <font color="red">权值越大越靠上</font></label>
